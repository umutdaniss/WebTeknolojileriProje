...
<body>
    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="img/siirt7.jpg" class="d-block w-100 resimSlider" alt="...">
            </div>
            <div class="carousel-item">
                <img src="img/siirt4.jpg" class="d-block w-100 resimSlider" alt="...">
            </div>
            <div class="carousel-item">
                <img src="img/siirt5.jpeg" class="d-block w-100 resimSlider" alt="...">
            </div>
        </div>
    ...
    <div class="bg-dark text-light text-center mb-0">
        <p class="align-middle p-0 mb-0 ">
            ...
            <span>Designed by <b>Umut</b> </span>
        </p>
